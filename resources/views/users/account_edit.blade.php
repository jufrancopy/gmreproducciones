                ...
                <div class="row mtop16">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::number('day', $birthday[2],['class'=>'form-control', 'min'=>01, 'max'=>31,
                            'required', 'placeholder'=>'11'] )
                            !!}
                            {!! Form::select('month', getMonths('list', null), $birthday[1],['class'=>'form-select',
                            'placeholder'=>'Noviembre']) !!}
                            {!! Form::number('year', $birthday[0],['class'=>'form-control', 'min'=>getUserYears()[1],
                            'max'=>
                            getUserYears()[0], 'required', 'placeholder'=>'1981'] ) !!}
                    ...
                    <div class="row mtop16">
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('gender', ['0'=>'Indefinido', '1'=>'Masculino', '2'=>'Femenino'],
                                Auth::user()->gender,['class'=>'form-select'])
                                !!}
                            </div>
                        </div>
                    </div>
