                                            ...
                                            @foreach ($product->getInventory as $inventory)
                                                <li>
                                                    <a href="#" class="inventory" id="inventory_{{ $inventory->id }}"
                                                        data-inventory-id="{{ $inventory->id }}">{{ $inventory->name }} -
                                                        <span class="price">
                                                            {{ Config::get('configSite.currency') . number_format($inventory->price, 2, '.', ',') }}</span>
                                                    </a>
                                                </li>
                                            @endforeach
                                        </ul>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="btn btn-success"><a
                                                href="https://wa.me/595983266831?text=Hola. Me gustaría hacer reservas para el concierto!"
                                                class="text-white">
                                                <i class="fa fa-whatsapp text-white" aria-hidden="true"></i> Reservar por
                                                Whatsapp</a>
                                        </div>
                                    </div>
                                </div>
