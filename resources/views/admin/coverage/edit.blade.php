...
<li class="breadcrumb-item">
    <a href="{{'/admin/coverage'}}"><i class="fas fa-shipping-fast"> Lista de Estados</i></a>
</li>
<li class="breadcrumb-item">
    <a href="{{'/admin/coverage/'.$coverage->id.'/edit'}}"><i class="far fa-edit"> Editar Dpto. de {{$coverage->name}}</i></a>
</li>
@endsection
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="panel shadow">
                <div class="header">
                    <h2 class="title"><i class="fas fa-edit"></i> Editar Dpto. {{$coverage->name}}</h2>
                </div>
                <div class="inside">
