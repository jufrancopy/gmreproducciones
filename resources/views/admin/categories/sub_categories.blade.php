                ...
                <div class="inside">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    @if(!is_null($subCategory->icono))
                                    <img src="{{ url('/uploads/'.$subCategory->file_path.'/'.$subCategory->icono)  }}"
                                        class="img-fluid">
                                    @endif
                                </td>
                                ...
                                <td>
                                    <div class="opts">
                                        ...
                                        <a href="{{url('/admin/category/'.$subCategory->id.'/edit')}}" data-toogle="tooltip"
                                            data-toggle="tooltip" data-placement="top" title="Eliminar"><i
                                                class="fas fa-edit"></i>
                                        </a>
                                        @endif
                                        @if(is_null($subCategory->deleted_at))
                                        <a href="#" data-path="admin/category" data-action="delete" data-object={{
                                            $subCategory->id
