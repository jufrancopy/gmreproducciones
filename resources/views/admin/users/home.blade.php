                    ...
                    <tr>
                        ...
                        <td>
                            <div class="opts">
                                ...
                                <a href="{{url('/admin/user/'.$user->id.'/edit')}}" data-toogle="tooltip"
                                    data-toggle="tooltip" data-placement="top" title="Editar"><i
                                        class="fas fa-edit"></i>
                                </a>
                                @endif
                                @if(kvfj(Auth::user()->permissions, 'user_permissions'))
                                <a href="{{url('/admin/user/'.$user->id.'/permissions')}}" data-toogle="tooltip"
                                    data-toggle="tooltip" data-placement="top" title="Permisos de Usuarios"><i
                                        class="fas fa-cogs"></i>
                                </a>
                                @endif
                            </div>
