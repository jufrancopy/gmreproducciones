                ...
                <div class="panel shadow">
                    ...
                    <div class="inside">
                        <div class="mini_profile">
                            ...
                            @if($user->status == 100)
                            <a href="{{url('/admin/user/'.$user->id.'/banned')}}" class="btn btn-info">Reactivar
                                Usuario</a>
                            @else
                            <a href="{{url('/admin/user/'.$user->id.'/banned')}}" class="btn btn-danger">Suspender
                                Usuario</a>
                            @endif
                            @endif
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::select('user_role', getRoleUserArray('list', null), $user->role,
                                    ['class'=>'form-select'] ) !!}
                                </div>
                            </div>
                        </div>
