                ...
                <div class="panel shadow">
                    ...
                    <div class="inside">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('website', Config::get('configSite.website'), ['class' => 'form-control', 'required']) !!}
                        </div>
                ...
                <div class="panel shadow">
                    ...
                    <div class="inside">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::number('purchase_min_amount', Config::get('configSite.purchase_min_amount'), [
                                'class' => 'form-select',
                                'min' => 1,
                                'required',
                            ]) !!}
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select('shipping_method', getShippingMethod(), Config::get('configSite.shipping_method'), [
                                'class' => 'form-select',
                                'required',
                            ]) !!}
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select('to_go', getEnableOrNotEnable(), Config::get('configSite.to_go'), ['class' => 'form-select']) !!}
                        </div>
                ...
                <div class="panel shadow">
                    ...
                    <div class="inside">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('social_facebook', Config::get('configSite.social_facebook'), [
                                'class' => 'form-control',
                                'required',
                            ]) !!}
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('social_instagram', Config::get('configSite.social_instagram'), [
                                'class' => 'form-control',
                                'required',
                            ]) !!}
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('social_twitter', Config::get('configSite.social_twitter'), [
                                'class' => 'form-control',
                                'required',
                            ]) !!}
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('social_youtube', Config::get('configSite.social_youtube'), [
                                'class' => 'form-control',
                                'required',
                            ]) !!}
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('social_whatsapp', Config::get('configSite.social_whatsapp'), [
                                'class' => 'form-control',
                                'required',
                            ]) !!}
                        </div>
                ...
                <div class="panel shadow">
                    ...
                    <div class="inside">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select('payment_method_cash', getEnableOrNotEnable(), Config::get('configSite.payment_method_cash'), [
                                'class' => 'form-select',
                            ]) !!}
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select(
                                ...
                                Config::get('configSite.payment_method_transfer'),
                                ['class' => 'form-select'],
                            ) !!}
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::textarea(
                                'payment_method_transfer_accounts_bank',
                                Config::get('configSite.payment_method_transfer_accounts_bank'),
                                ['class' => 'form-control', 'rows' => 3, 'id' => 'editor'],
                            ) !!}
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select(
                                ...
                                getEnableOrNotEnable(),
                                Config::get('configSite.payment_method_paypal'),
                                ['class' => 'form-select'],
                            ) !!}
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select(
                                ...
                                getEnableOrNotEnable(),
                                Config::get('configSite.payment_method_credit_card'),
                                ['class' => 'form-select'],
                            ) !!}
                        </div>
                    </div>
                ...
                <div class="panel shadow">
                    ...
                    <div class="inside">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::number('product_per_page', Config::get('configSite.product_per_page'), [
                                'class' => 'form-control',
                                'required',
                                'min' => 1,
                                'required',
                        ...
                        <label for="product_per_page_random" class="mtop16">Productos a mostrar por página
                            (Random):</label>
                        <div class="input-group">
                            <span class="input-group-text" id="basic-addon1">
                                <div class="far fa-keyboard"></div>
                ...
                <div class="panel shadow">
                    ...
                    <div class="inside">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('upload_server_path', Config::get('configSite.upload_server_path'), [
                                'class' => 'form-control',
                                'required',
                            ]) !!}
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('server_webapp_path', Config::get('configSite.server_webapp_path'), ['class' => 'form-control']) !!}
                        </div>
                    </div>
                </div>
            </div>
