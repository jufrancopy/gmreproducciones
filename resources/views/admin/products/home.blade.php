                                        ...
                                        @if (kvfj(Auth::user()->permissions, 'product_delete'))
                                            ...
                                            @else
                                                <a href="{{ url('/admin/product/' . $product->id . '/restore') }}"
                                                    data-action="restore" data-path="admin/product"
                                                    data-object={{ $product->id }} data-toggle="tooltip"
                                                    data-placement="top" title="Restaurar" class="btn_deleted restore"
                                                    data-action="restore" data-path="admin/category"
                                                    data-object="{{ $product->id }}"><i class="fas fa-trash-restore"></i>
                                                </a>
                                            @endif
                                        @endif
                                    </div>
