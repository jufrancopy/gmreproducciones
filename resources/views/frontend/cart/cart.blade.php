                ...
                <div class="items mtop32">
                    <div class="row">
                        <div class="col-md-9">
                                                    ...
                                                    <td><a
                                                        ...
                                                        @if ($item->discount_status == 1)
                                                            ...
                                                            <div class="price_discount">
                                                                <span
                                                                    class="price_initial">{{ number_format($item->price_initial, 2, '.', ',') . Config::get('configSite.currency') }}</span>
                                                        @endif
                                                        <span
                            ...
                            <div class="row mtop16" id="payment_method_transfer_info" style="display: none">
                                <div class="col-md-6">
                                    <div class="panel mtop32">
                                        <div class="inside">
                                            <div class="header">
                                                <h2 class="title"><i class="fas fa-shopping-cart"></i> Tranferencia y
                                                    Depósito</h2>
                                            </div>
                                            <div class="inside">
                                ...
                                <div class="col-md-6">
                                    <div class="panel mtop32">
                                        <div class="inside">
                                            <div class="header">
                                                <h2 class="title"><i class="fas fa-shopping-cart"></i> Subir Comprobante
                                                </h2>
                                            </div>
                                            <div class="inside">
                                                <a href="#" id="payment_method_transfer_select_file"
                                                    class="file_select">
                                                    <img src="{{ url('/static/images/upload_file.png') }}" alt="">
                                                </a>
                                                <img src="" class="img-fluid mtop16"
                                                    id="payment_method_transfer_img_prew">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3 detail_shipping">
                            ...
                            {!! Form::file('payment_method_transfer_file', [
                                'id' => 'payment_method_transfer_file',
                                'accept' => 'image/*',
                                'style' => 'display:none',
                            ]) !!}
                            <div class="panel">
                                    ...
                                    <div class="detail_shipping_info">
                                        @if ($order->o_type == 0)
                                            ...
                                            @else
                                                ...
                                                <p><a href="{{ url('/account/address') }}"
                                                        class="btn btn-dark w-100">Agregar Dirección de
                                                        Envío</a></p>
                                            @endif
                                        @endif
                        ...
                        @if (!is_null(Auth::user()->getAddressDefault))
                            <div class="panel mtop16">
                                <div class="inside">
                                    {{ Form::submit('Completar la Orden', [
