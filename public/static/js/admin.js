...
function delete_object(e) {
    ...
    if (action == 'delete') {
        jealert({
            title: 'Estás seguro?', type: 'delete', msg: 'Este archivo se enviará a la papelera.', actions: JSON.stringify([{ url: url, name: 'Estoy seguro', type: 'danger' }])
        });
    } else {
        jealert({
            title: 'Desea restaurarlo?', type: 'restore', msg: 'Se restaurará el elemento.', actions: JSON.stringify([{ url: url, name: 'Estoy seguro', type: 'info' }])
        });
    }
